    ...
    return (
        <div className="">
            <footer className="mx-auto flex flex-row p-2 text-center items-center footer bg-neutral text-neutral-content">
                <div className="grid-flow-col gap-4 text-center pl-2">
                    <a href="https://github.com/pikamuchu/pika-pikadex-app/">
